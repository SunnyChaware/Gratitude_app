        ...
        <div className="flex flex-col md:flex-row px-5 md:px-30 lg:px-40 2xl:px-80 h-screen items-center justify-center" style={{marginTop: '-60px'}}>
            <div className='md:w-1/2 text-center md:text-left'>
                <div className=''>
                    ...
                    <div className='flex flex-col items-center md:flex-row md:justify-start justify-center'>
                      <button
                        type="button"
                        className="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300
                        font-medium rounded-lg text-sm w-40 h-10 me-2 mb-2 md:mb-0 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
                      >
                        Get Started 
                      </button>
                      <button
                        type="button"
                        className="w-40 h-10 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg 
                        border border-gray-200 hover:bg-gray-100 hover:text-green-700 focus:z-10 focus:ring-4 focus:ring-gray-100
                        dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-green"
                       >
                        Sign Up
                      </button>
                    </div>
